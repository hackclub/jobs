...
func main() {
	...
	files := [][]string{
		...
		{"education_engineer.md", "https://github.com/hackclub/jobs/blob/main/directory/education-engineer.md"},
		{"communications_manager.md", "https://github.com/hackclub/jobs/blob/main/directory/communications-manager.md"},
